#ifndef _CLIENT_DADOS_H
#define _CLIENT_DADOS_H
...
private:
    ...
    void alocar(unsigned NM);
    void copiar(const Conversa &C);
...
private:
    ...
    void alocar(unsigned NC);
    void copiar(const DataClient &DC);
public:
